...
# This is the main certificate template image which will be used to generate all the certificates
# template_image_path = 'E:\Path-to-your-own-template-image\CERTIFICATE_TEMPLATE_IMAGE.png'
template_image_path = os.path.normpath('./CERTIFICATE_TEMPLATE_IMAGE.png')

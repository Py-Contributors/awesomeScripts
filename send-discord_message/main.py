...
name_label = tk.Label(root, text = 'Username',font=('calibre', 11, 'bold'), bg ="#0f3057") 

   
name_entry = tk.Entry(root,textvariable = name_var,font=('calibre',10,'normal')) 
   

text_label = tk.Label(root,text = 'Text', font = ('calibre',11,'bold'), bg ="#0f3057") 
   

text_entry=tk.Entry(root, textvariable = text_var, font = ('calibre',10,'normal')) 
   

sub_btn=tk.Button(root,text = 'Submit',command = submit, bg = "#9ab3f5") 
